...
testBinBuildRequires() {
  ...
  assertExitCode 0 bashCheckRequires --ignore __catch --ignore-prefix returnEnvironment --ignore-prefix __decorateExtension --require --unused --report "$home/bin/build/map.sh" || return $?
