...
# shellcheck disable=SC2016
helpPlain='Usage: darwinNotification [ --title ] [ --debug ] [ --sound soundName ] [ message ... ]'$'\n'''$'\n''    --title            String. Optional. Title of the notification.'$'\n''    --debug            Flag. Optional. Output the osascript as [[(code)]mdarwinNotification.debug at the application root after this call.'$'\n''    --sound soundName  String. Optional. Sound to play with the notification. Represents a sound base name found in [[(code)]m/Library/Sounds/.'$'\n''    message ...        String. Optional. Message to display to the user in the dialog.'$'\n'''$'\n''Display a notification for the user'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.717
