...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: colorFormat [ format ] [ red ] [ green ] [ blue ] [ --help ]'$'\n'''$'\n''    format  [[(value)]mString. Optional. Formatting string.'$'\n''    red     [[(value)]mUnsignedInteger. Optional. Red component.'$'\n''    green   [[(value)]mUnsignedInteger. Optional. Blue component.'$'\n''    blue    [[(value)]mUnsignedInteger. Optional. Green component.'$'\n''    --help  [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Take r g b decimal values and convert them to hex color values'$'\n''Takes arguments or stdin values in groups of 3.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Reads from stdin:'$'\n''list:UnsignedInteger'$'\n'''
# elapsed 3.664
