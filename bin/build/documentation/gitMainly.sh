...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mgitMainly'$'\n'''$'\n''Merge [[(code)]mstaging and [[(code)]mmain branches of a git repository into the current branch.'$'\n''Will merge [[(code)]morigin/staging and [[(code)]morigin/main after doing a [[(code)]m--pull for both of them'$'\n''Current repository should be clean and have no modified files.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m1 - Already in main, staging, or HEAD, or git merge failed'$'\n''- [[(code)]m0 - git merge succeeded'$'\n'''
