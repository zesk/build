...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mjsonFileSet [[(bold)]m[[(magenta)]mjsonFile [[(bold)]m[[(magenta)]mpath [[(blue)]m[ value ... ]'$'\n'''$'\n''    [[(red)]mjsonFile   [[(value)]mFile. Required. File to get value from.'$'\n''    [[(red)]mpath       [[(value)]mString. Required. dot-separated path to modify (e.g. [[(code)]mextra.fingerprint)'$'\n''    [[(blue)]mvalue ...  [[(value)]mEmptyString. Optional. Value to set. If more than one value is set, value is set to an array value. If no value passed, the key is deleted. [[(red)]mNote the difference between a blank argument and NO argument.'$'\n'''$'\n''Set or delete a value in a JSON file'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
