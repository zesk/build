...
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]mexecutableExists'$'\e''[0m '$'\e''[[(blue)]m[ --any ]'$'\e''[0m '$'\e''[[(bold)]m'$'\e''[[(magenta)]mbinary ...'$'\e''[0m'$'\e''[0m '$'\e''[[(blue)]m[ --help ]'$'\e''[0m'$'\n'''$'\n''    '$'\e''[[(blue)]m--any       '$'\e''[[(value)]mFlag. Optional. If any binary exists then return 0 (success). Otherwise, all binaries must exist.'$'\e''[[(reset)]m'$'\n''    '$'\e''[[(red)]mbinary ...  '$'\e''[[(value)]mString. Required. One or more Binaries to find in the system '$'\e''[[(code)]mPATH'$'\e''[[(reset)]m.'$'\e''[[(reset)]m'$'\n''    '$'\e''[[(blue)]m--help      '$'\e''[[(value)]mFlag. Optional. Display this help.'$'\e''[[(reset)]m'$'\n'''$'\n''Does a binary exist in the PATH?'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - If all values are found (without the '$'\e''[[(code)]m--any'$'\e''[[(reset)]m flag), or if '$'\e''[[(cyan)]many'$'\e''[[(reset)]m binary is found with the '$'\e''[[(code)]m--any'$'\e''[[(reset)]m flag'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - If any value is not found (without the '$'\e''[[(code)]m--any'$'\e''[[(reset)]m flag), or if '$'\e''[[(cyan)]mall'$'\e''[[(reset)]m binaries are NOT found with the '$'\e''[[(code)]m--any'$'\e''[[(reset)]m flag.'$'\n'''$'\n''Example:'$'\n''    executableExists cp date aws ls mv stat || throwEnvironment "$handler" "Need basic environment to work" || return $?'$'\n''    executableExists --any terraform tofu || throwEnvironment "$handler" "No available infrastructure providers" || return $?'$'\n''    executableExists --any curl wget || throwEnvironment "$handler" "No way to download URLs easily" || return $?'
# shellcheck disable=SC2016
helpPlain='Usage: executableExists [ --any ] binary ... [ --help ]'$'\n'''$'\n''    --any       Flag. Optional. If any binary exists then return 0 (success). Otherwise, all binaries must exist.'$'\n''    binary ...  String. Required. One or more Binaries to find in the system PATH.'$'\n''    --help      Flag. Optional. Display this help.'$'\n'''$'\n''Does a binary exist in the PATH?'$'\n'''$'\n''Return codes:'$'\n''- 0 - If all values are found (without the --any flag), or if any binary is found with the --any flag'$'\n''- 1 - If any value is not found (without the --any flag), or if all binaries are NOT found with the --any flag.'$'\n'''$'\n''Example:'$'\n''    executableExists cp date aws ls mv stat || throwEnvironment "$handler" "Need basic environment to work" || return $?'$'\n''    executableExists --any terraform tofu || throwEnvironment "$handler" "No available infrastructure providers" || return $?'$'\n''    executableExists --any curl wget || throwEnvironment "$handler" "No way to download URLs easily" || return $?'
