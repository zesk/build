...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: fileType [[(blue)]m[ item ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]mitem    [[(value)]mString. Optional. Thing to classify'$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Better type handling of shell objects'$'\n''Outputs one of [[(code)]mtype output or enhancements:'$'\n''- [[(code)]mbuiltin, [[(code)]mfunction, [[(code)]malias, [[(code)]mfile'$'\n''- [[(code)]mlink-directory, [[(code)]mlink-file, [[(code)]mlink-dead, [[(code)]mdirectory, [[(code)]minteger, [[(code)]munknown'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
