...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdateValid [[(blue)]m[ --help ] [[(blue)]m[ -- ] [[(magenta)]mtext'$'\n'''$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--      [[(value)]mFlag. Optional. Stops command processing to enable arbitrary text to be passed as additional arguments without special meaning.'$'\n''    [[(red)]mtext    [[(value)]mString. Required. Text to validate as a date after the year 1600. Does not validate month and day combinations.'$'\n'''$'\n''Is a date valid?'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 2.074
