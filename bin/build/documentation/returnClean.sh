...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: returnClean [[(magenta)]mexitCode [[(blue)]m[ item ]'$'\n'''$'\n''    [[(red)]mexitCode  [[(value)]mInteger. Required. Exit code to return.'$'\n''    [[(blue)]mitem      [[(value)]mExists. Optional. One or more files or folders to delete, failures are logged to stderr.'$'\n'''$'\n''Delete files or directories and return the same exit code passed in.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 2.515
