...
usage="mockEnvironmentStart"
# shellcheck disable=SC2016
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]mmockEnvironmentStart'$'\e''[0m'$'\n'''$'\n''Fake a value for testing'$'\n''Argument: globalName - EnvironmentVariable. Required. Global to change temporarily to a value.'$'\n''Argument: value - EmptyString. Optional. Force the value of '$'\e''[[(code)]mglobalName'$'\e''[[(reset)]m to this value temporarily. Saves the original value.'$'\n''Argument: ... - Continue passing pairs of globalName value to mock additional values.'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'$'\n'''
# shellcheck disable=SC2016
helpPlain='Usage: mockEnvironmentStart'$'\n'''$'\n''Fake a value for testing'$'\n''Argument: globalName - EnvironmentVariable. Required. Global to change temporarily to a value.'$'\n''Argument: value - EmptyString. Optional. Force the value of globalName to this value temporarily. Saves the original value.'$'\n''Argument: ... - Continue passing pairs of globalName value to mock additional values.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 0.473
