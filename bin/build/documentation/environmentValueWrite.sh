...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]menvironmentValueWrite [[(bold)]m[[(magenta)]mname [[(blue)]m[ value ] [[(blue)]m[ ... ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mname    [[(value)]mString. Required. Name to write.'$'\n''    [[(blue)]mvalue   [[(value)]mEmptyString. Optional. Value to write.'$'\n''    [[(blue)]m...     [[(value)]mEmptyString. Optional. Additional values, when supplied, write this value as an array.'$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Write a value to a state file as NAME="value"'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
