...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdirectoryOldestFile [[(bold)]m[[(magenta)]mdirectory [[(blue)]m[ --find findArgs ... -- ]'$'\n'''$'\n''    [[(red)]mdirectory               [[(value)]mDirectory. Required. Directory to search for the oldest file.'$'\n''    [[(blue)]m--find findArgs ... --  [[(value)]mArguments. Optional. Arguments delimited by a double-dash (or end of argument list)'$'\n'''$'\n''Find the oldest modified file in a directory'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.34
