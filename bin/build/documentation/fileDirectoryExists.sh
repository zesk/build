...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mfileDirectoryExists [[(magenta)]mdirectory'$'\n'''$'\n''    [[(red)]mdirectory  Directory. Required. Test if file directory exists (file does not have to exist)'$'\n'''$'\n''Does the file'\''s directory exist?'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
