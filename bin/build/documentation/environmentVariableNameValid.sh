...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: environmentVariableNameValid [[(bold)]mvariableName ... [ --help ]'$'\n'''$'\n''    variableName ...  [[(value)]mString. Required. Exit status 0 if all variables names are valid ones.'$'\n''    --help            [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Validates zero or more environment variable names.'$'\n''- alpha'$'\n''- digit'$'\n''- underscore'$'\n''First letter MUST NOT be a digit'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.564
