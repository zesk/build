...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mreadlineConfigurationAdd [ --help ] [[(magenta)]mkeyStroke [[(magenta)]maction'$'\n'''$'\n''    --help     [[(value)]mFlag. Optional. Display this help.'$'\n''    keyStroke  [[(value)]mString. Required.'$'\n''    action     [[(value)]mString. Required.'$'\n'''$'\n''Add configuration to ~/.inputrc for a key binding'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Example:'$'\n''readlineConfigurationAdd "\ep" history-search-backward'$'\n'''
# elapsed 4.084
