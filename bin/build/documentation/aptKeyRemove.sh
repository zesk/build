...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]maptKeyRemove [[(bold)]m[[(magenta)]mkeyName [[(blue)]m[ --skip ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mkeyName  [[(value)]mString. Required. One or more key names to remove.[[(reset)]m'$'\n''    [[(blue)]m--skip   [[(value)]mFlag. Optional. a Do not do [[(code)]mapt-get update[[(reset)]m afterwards to update the database.[[(reset)]m'$'\n''    [[(blue)]m--help   [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Remove apt keys'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m1[[(reset)]m - if environment is awry'$'\n''- [[(code)]m0[[(reset)]m - Apt key was removed AOK'$'\n'''
