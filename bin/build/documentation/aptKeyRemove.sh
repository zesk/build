...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]maptKeyRemove [[(magenta)]mkeyName [[(blue)]m[ --skip ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mkeyName  [[(value)]mString. Required. One or more key names to remove.'$'\n''    [[(blue)]m--skip   [[(value)]mFlag. Optional. a Do not do apt-get update afterwards to update the database.'$'\n''    [[(blue)]m--help   [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Remove apt keys'$'\n'''$'\n''Return codes:'$'\n''- 1 - if environment is awry'$'\n''- 0 - Apt key was removed AOK'$'\n'''
