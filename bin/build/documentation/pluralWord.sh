...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mpluralWord [[(bold)]m[[(magenta)]mnumber [[(bold)]m[[(magenta)]msingular [[(blue)]m[ plural ]'$'\n'''$'\n''    [[(red)]mnumber    [[(value)]mNumber. Required. An integer or floating point number'$'\n''    [[(red)]msingular  [[(value)]mString. Required. The singular form of a noun'$'\n''    [[(blue)]mplural    [[(value)]mString. Optional. The plural form of a noun. If not specified uses [[(code)]msingular plus an ess.'$'\n'''$'\n''Plural word which includes the numeric prefix and the noun.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''[[(code)]mString. The number (direct) and the plural form for non-1 values. e.g. [[(code)]m$(pluralWord 2 potato potatoes) = [[(code)]m2 potatoes'$'\n'''$'\n''Example:'$'\n''    count=$(fileLineCount "$foxSightings") || return $?'$'\n''    printf "We saw %s.\n" "$(pluralWord "$count" fox foxes)"'$'\n'''
# elapsed 2.811
