...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mpathConfigure [[(blue)]m[ --help ] [[(blue)]m[ --first ] [[(blue)]m[ --last ] [[(blue)]m[ path ]'$'\n'''$'\n''    [[(blue)]m--help   Flag. Optional. Display this help.'$'\n''    [[(blue)]m--first  Flag. Optional. Place any paths after this flag first in the list'$'\n''    [[(blue)]m--last   Flag. Optional. Place any paths after this flag last in the list. Default.'$'\n''    [[(blue)]mpath     the path to be added to the [[(code)]mPATH environment'$'\n'''$'\n''Modify the PATH environment variable to add a path.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
