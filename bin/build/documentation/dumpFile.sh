...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mdumpFile [[(blue)]m[ fileName0 ] [[(blue)]m[ --symbol symbolString ] [[(blue)]m[ --lines lineCount ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]mfileName0              File. Optional. File to dump.'$'\n''    [[(blue)]m--symbol symbolString  String. Optional. Prefix for each output line.'$'\n''    [[(blue)]m--lines lineCount      PositiveInteger. Optional. Number of lines to output.'$'\n''    [[(blue)]m--help                 Flag. Optional. Display this help.'$'\n'''$'\n''Output a file for debugging'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Reads from stdin:'$'\n''text (optional)'$'\n'''$'\n''Writes to stdout:'$'\n''formatted text (optional)'$'\n'''
# elapsed 4.706
