...
# shellcheck disable=SC2016
helpPlain='Usage: colorMultiply [[(magenta)]mfactor [[(magenta)]mredValue [[(magenta)]mgreenValue [[(magenta)]mblueValue [ --help ]'$'\n'''$'\n''    [[(red)]mfactor      floatValue. Required. Red RGB value (0-255)'$'\n''    [[(red)]mredValue    Integer. Required. Red RGB value (0-255)'$'\n''    [[(red)]mgreenValue  Integer. Required. Red RGB value (0-255)'$'\n''    [[(red)]mblueValue   Integer. Required. Red RGB value (0-255)'$'\n''    --help      Flag. Optional. Display this help.'$'\n'''$'\n''Multiply color values by a factor and return the new values'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.333
