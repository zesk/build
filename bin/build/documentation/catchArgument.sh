...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mcatchArgument [[(bold)]m[[(magenta)]mhandler [[(bold)]m[[(magenta)]mcommand ...'$'\n'''$'\n''    [[(red)]mhandler      [[(value)]mFunction. Required. Failure command[[(reset)]m'$'\n''    [[(red)]mcommand ...  [[(value)]mCallable. Required. Command to run.[[(reset)]m'$'\n'''$'\n''Run [[(code)]mcommand[[(reset)]m, upon failure run [[(code)]mhandler[[(reset)]m with an argument error'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
