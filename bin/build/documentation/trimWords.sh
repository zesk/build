...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mtrimWords [[(blue)]m[ wordCount ] [[(blue)]m[ word0 ... ]'$'\n'''$'\n''    [[(blue)]mwordCount  [[(value)]mPositiveInteger. Words to output'$'\n''    [[(blue)]mword0 ...  [[(value)]mEmptyString. One or more words to output'$'\n'''$'\n''Remove words from the end of a phrase'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Example:'$'\n''    printf "%s: %s\n" "Summary:" "$(trimWords 10 $description)"'$'\n'''
