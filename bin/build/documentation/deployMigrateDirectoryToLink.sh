...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdeployMigrateDirectoryToLink [[(magenta)]mdeployHome [[(magenta)]mapplicationPath'$'\n'''$'\n''    [[(red)]mdeployHome       [[(value)]mDirectory. Required. Deployment database home.'$'\n''    [[(red)]mapplicationPath  [[(value)]mDirectory. Required. Application target path.'$'\n'''$'\n''Automatically convert application deployments using non-links to links.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.645
