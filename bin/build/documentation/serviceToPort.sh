...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mserviceToPort [[(magenta)]mservice [ --services servicesFile ] [ --help ]'$'\n'''$'\n''    [[(red)]mservice                  [[(value)]mString. Required. A unix service typically found in /etc/services'$'\n''    --services servicesFile  [[(value)]mFile. Optional. File like '\''/etc/services.'$'\n''    --help                   [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Get the port number associated with a service'$'\n'''$'\n''Return codes:'$'\n''- 1 - service not found'$'\n''- 2 - bad argument or invalid port'$'\n''- 0 - service found and output is an integer'$'\n'''
