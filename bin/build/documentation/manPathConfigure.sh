...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mmanPathConfigure [[(blue)]m[ --help ] [[(blue)]m[ --first ] [[(blue)]m[ --last ] [[(blue)]m[ path ]'$'\n'''$'\n''    [[(blue)]m--help   [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n''    [[(blue)]m--first  [[(value)]mFlag. Optional. Place any paths after this flag first in the list[[(reset)]m'$'\n''    [[(blue)]m--last   [[(value)]mFlag. Optional. Place any paths after this flag last in the list. Default.[[(reset)]m'$'\n''    [[(blue)]mpath     [[(value)]mthe path to be added to the [[(code)]mMANPATH[[(reset)]m environment[[(reset)]m'$'\n'''$'\n''Modify the MANPATH environment variable to add a path.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
