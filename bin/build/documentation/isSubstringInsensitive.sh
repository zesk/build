...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: isSubstringInsensitive [[(bold)]m[[(magenta)]mneedle [ haystack ... ]'$'\n'''$'\n''    needle        [[(value)]mString. Required. Thing to search for, not blank.'$'\n''    haystack ...  [[(value)]mEmptyString. Optional. One or more array elements to match'$'\n'''$'\n''Check if one string is a substring of another set of strings (case-insensitive)'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - If element is a substring of any haystack'$'\n''- [[(code)]m1 - If element is NOT found as a substring of any haystack'$'\n'''
# elapsed 3.423
