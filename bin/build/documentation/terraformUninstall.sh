...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mterraformUninstall [[(blue)]m[ package ... ]'$'\n'''$'\n''    [[(blue)]mpackage ...  [[(value)]mString. Optional. Additional packages to uninstall using [[(code)]mpackageUninstall'$'\n'''$'\n''Remove terraform binary'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.61
