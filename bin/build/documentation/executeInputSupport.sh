...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mexecuteInputSupport [[(blue)]m[ executor ... -- ] [[(blue)]m[ -- ] [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(blue)]mexecutor ... --  The command to run on each line of input or on each additional argument. Arguments to prefix the final variable argument can be supplied prior to an initial --.'$'\n''    [[(blue)]m--               Alone after the executor forces stdin to be ignored. The -- flag is also removed from the arguments passed to the executor.'$'\n''    [[(blue)]m...              Any additional arguments are passed directly to the executor'$'\n'''$'\n''Support arguments and stdin as arguments to an executor'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
