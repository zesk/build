...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mfileExtractLines [[(bold)]m[[(magenta)]mstartLine [[(bold)]m[[(magenta)]mendLine [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mstartLine  [[(value)]mInteger. Required. Starting line number.'$'\n''    [[(red)]mendLine    [[(value)]mInteger. Required. Ending line number.'$'\n''    [[(blue)]m--help     [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Extract a range of lines from a file'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin:'$'\n''Reads lines until EOF'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''Outputs the selected lines only'$'\n'''
