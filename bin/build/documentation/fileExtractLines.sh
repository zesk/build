...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mfileExtractLines [[(magenta)]mstartLine [[(magenta)]mendLine [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mstartLine  Integer. Required. Starting line number.'$'\n''    [[(red)]mendLine    Integer. Required. Ending line number.'$'\n''    [[(blue)]m--help     Flag. Optional. Display this help.'$'\n'''$'\n''Extract a range of lines from a file'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Reads from stdin:'$'\n''Reads lines until EOF'$'\n'''$'\n''Writes to stdout:'$'\n''Outputs the selected lines only'$'\n'''
