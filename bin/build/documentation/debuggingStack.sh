...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdebuggingStack [[(blue)]m[ -x ] [[(blue)]m[ --me ] [[(blue)]m[ --exit ]'$'\n'''$'\n''    [[(blue)]m-x      [[(value)]mFlag. Optional. Show exported variables. (verbose)'$'\n''    [[(blue)]m--me    [[(value)]mFlag. Optional. Show calling function call stack frame.'$'\n''    [[(blue)]m--exit  [[(value)]mFlag. Optional. Exit with code 0 after output.'$'\n'''$'\n''Dump the function and include stacks and the current environment'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- BUILD_DEBUG'$'\n'''$'\n''BUILD_DEBUG settings:'$'\n''- debuggingStack - debuggingStack shows arguments passed (extra) and exports (optional flag) ALWAYS'$'\n'''
# elapsed 2.654
