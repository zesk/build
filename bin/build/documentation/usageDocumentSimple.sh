...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]musageDocumentSimple [[(blue)]m[ --help ] [[(bold)]msource [[(bold)]mfunction [[(bold)]mreturnCode [[(blue)]m[ message ... ]'$'\n'''$'\n''    [[(blue)]m--help       [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(red)]msource       [[(value)]mFile. Required. File where documentation exists.'$'\n''    [[(red)]mfunction     [[(value)]mString. Required. Function to document.'$'\n''    [[(red)]mreturnCode   [[(value)]mUnsignedInteger. Required. Exit code to return.'$'\n''    [[(blue)]mmessage ...  [[(value)]mString. Optional. Message to display to the user.'$'\n'''$'\n''Output a simple error message for a function'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
