...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: returnMap [ --help ] [ value ] [ from ] [ to ] [ ... ]'$'\n'''$'\n''    --help  [[(value)]mFlag. Optional. Display this help.'$'\n''    value   [[(value)]mInteger. A return value.'$'\n''    from    [[(value)]mInteger. When value matches from, instead return to'$'\n''    to      [[(value)]mInteger. The value to return when from matches value'$'\n''    ...     [[(value)]mAdditional from-to pairs can be passed, first matching value is used, all values will be examined if none match'$'\n'''$'\n''map a return value from one value to another'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
