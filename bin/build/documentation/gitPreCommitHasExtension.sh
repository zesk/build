...
# shellcheck disable=SC2016
helpPlain='Usage: gitPreCommitHasExtension [[(blue)]m[ extension ]'$'\n'''$'\n''    [[(blue)]mextension  String. Optional. Extension to check. Use ! for blank extension and @ for all extensions. Can specify one or more.'$'\n'''$'\n''Does this commit have the following file extensions?'$'\n'''$'\n''Return codes:'$'\n''- 0 - if all extensions are present'$'\n''- 1 - if any extension is not present'$'\n'''
# elapsed 2.048
