...
usage="githubLatestRelease"
# shellcheck disable=SC2016
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]mgithubLatestRelease'$'\e''[0m'$'\n'''$'\n''Get the latest release version'$'\n''Argument: projectName - String. Required. Github project name in the form of '$'\e''[[(code)]mowner/repository'$'\e''[[(reset)]m'$'\n''Environment: GITHUB_ACCESS_TOKEN'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'$'\n'''
# shellcheck disable=SC2016
helpPlain='Usage: githubLatestRelease'$'\n'''$'\n''Get the latest release version'$'\n''Argument: projectName - String. Required. Github project name in the form of owner/repository'$'\n''Environment: GITHUB_ACCESS_TOKEN'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 0.443
