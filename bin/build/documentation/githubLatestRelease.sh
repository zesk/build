...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mgithubLatestRelease [[(bold)]m[[(magenta)]mprojectName'$'\n'''$'\n''    [[(red)]mprojectName  [[(value)]mString. Required. Github project name in the form of [[(code)]mowner/repository'$'\n'''$'\n''Get the latest release version'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- GITHUB_ACCESS_TOKEN'$'\n'''
