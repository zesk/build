...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mawsS3DirectoryDelete [[(blue)]m[ --help ] [[(blue)]m[ --handler handler ] [[(blue)]m[ --show ] [[(magenta)]murl ...'$'\n'''$'\n''    [[(blue)]m--help             Flag. Optional. Display this help.'$'\n''    [[(blue)]m--handler handler  Function. Optional. Use this error handler instead of the default error handler.'$'\n''    [[(blue)]m--show             Flag. Optional. Show what would change, do not change anything.'$'\n''    [[(red)]murl ...            URL. Required. AWS S3 URL to delete'$'\n'''$'\n''Delete a directory remotely on S3'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
