...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mawsS3DirectoryDelete [[(blue)]m[ --help ] [[(blue)]m[ --handler handler ] [[(blue)]m[ --show ] [[(bold)]m[[(magenta)]murl ...'$'\n'''$'\n''    [[(blue)]m--help             [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--handler handler  [[(value)]mFunction. Optional. Use this error handler instead of the default error handler.'$'\n''    [[(blue)]m--show             [[(value)]mFlag. Optional. Show what would change, do not change anything.'$'\n''    [[(red)]murl ...            [[(value)]mURL. Required. AWS S3 URL to delete'$'\n'''$'\n''Delete a directory remotely on S3'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 2.359
