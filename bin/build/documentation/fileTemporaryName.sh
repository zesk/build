...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mfileTemporaryName [[(bold)]m[[(magenta)]mhandler [[(blue)]m[ --help ] [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(red)]mhandler  [[(value)]mFunction. Required. Function to call on failure. Function Type: returnMessage'$'\n''    [[(blue)]m--help   [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m...      [[(value)]mArguments. Optional. Any additional arguments are passed through.'$'\n'''$'\n''Wrapper for [[(code)]mmktemp. Generate a temporary file name, and fail using a function'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- BUILD_DEBUG'$'\n'''$'\n''[[(code)]mBUILD_DEBUG settings:'$'\n''- [[(code)]mtemp - Logs backtrace of all temporary files to a file in application root named after this function to detect and clean up leaks'$'\n'''
