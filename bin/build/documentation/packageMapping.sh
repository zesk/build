...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mpackageMapping [[(blue)]m[ packageName ] [[(blue)]m[ --manager packageManager ]'$'\n'''$'\n''    [[(blue)]mpackageName               A simple package name which will be expanded to specific platform or package-manager specific package names'$'\n''    [[(blue)]m--manager packageManager  String. Optional. Package manager to use. (apk, apt, brew)'$'\n'''$'\n''No documentation for [[(code)]mpackageMapping.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.79
