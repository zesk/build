...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mcolorScheme [ --help ] [ --handler handler ] [ --debug ]'$'\n'''$'\n''    --help             [[(value)]mFlag. Optional. Display this help.'$'\n''    --handler handler  [[(value)]mFunction. Optional. Use this error handler instead of the default error handler.'$'\n''    --debug            [[(value)]mFlag. Optional. Show additional debugging information.'$'\n'''$'\n''Set the terminal color scheme to the specification'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin:'$'\n''Scheme definition with [[(code)]mcolorName=colorValue on each line'$'\n'''
