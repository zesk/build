...
# shellcheck disable=SC2016
helpPlain='Usage: hookVersionCurrent [[(blue)]m[ --help ] [[(blue)]m[ --application application ]'$'\n'''$'\n''    [[(blue)]m--help                     Flag. Optional. Display this help.'$'\n''    [[(blue)]m--application application  Directory. Optional. Application home directory.'$'\n'''$'\n''Application current version'$'\n''Extracts the version from the repository'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
