...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mlistRemove [[(bold)]m[[(magenta)]mlistValue [[(bold)]m[[(magenta)]mseparator [[(blue)]m[ item ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mlistValue  [[(value)]mRequired. List value to modify.[[(reset)]m'$'\n''    [[(red)]mseparator  [[(value)]mRequired. Separator string for item values (typically [[(code)]m:[[(reset)]m)[[(reset)]m'$'\n''    [[(blue)]mitem       [[(value)]mthe item to be removed from the [[(code)]mlistValue[[(reset)]m[[(reset)]m'$'\n''    [[(blue)]m--help     [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Remove one or more items from a text-delimited list'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
