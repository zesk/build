...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mcatchCode [[(bold)]m[[(magenta)]mcode [[(bold)]m[[(magenta)]mhandler [[(bold)]m[[(magenta)]mcommand ...'$'\n'''$'\n''    [[(red)]mcode         [[(value)]mUnsignedInteger. Required. Exit code to return'$'\n''    [[(red)]mhandler      [[(value)]mFunction. Required. Failure command, passed remaining arguments and error code.'$'\n''    [[(red)]mcommand ...  [[(value)]mCallable. Required. Command to run.'$'\n'''$'\n''Run [[(code)]mcommand, handle failure with [[(code)]mhandler with [[(code)]mcode and [[(code)]mcommand as error'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
