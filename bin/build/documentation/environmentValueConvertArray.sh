...
usage="environmentValueConvertArray"
# shellcheck disable=SC2016
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]menvironmentValueConvertArray'$'\e''[0m'$'\n'''$'\n''Convert an array value which was loaded already'$'\n''Argument: encodedValue - String. Required. Value to convert to tokens, one per line'$'\n''stdout: Array values separated by newlines'$'\n''Argument: --help - Flag. Optional. Display this help.'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'$'\n'''
# shellcheck disable=SC2016
helpPlain='Usage: environmentValueConvertArray'$'\n'''$'\n''Convert an array value which was loaded already'$'\n''Argument: encodedValue - String. Required. Value to convert to tokens, one per line'$'\n''stdout: Array values separated by newlines'$'\n''Argument: --help - Flag. Optional. Display this help.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 0.457
