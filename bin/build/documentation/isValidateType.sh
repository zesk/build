...
usage="isValidateType"
# shellcheck disable=SC2016
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]misValidateType'$'\e''[0m'$'\n'''$'\n''Are all arguments passed a valid validate type?'$'\n''Argument: --help - Flag. Optional. Display this help.'$'\n''Argument: type - String. Optional. Type to validate as '$'\e''[[(code)]mvalidate'$'\e''[[(reset)]m type.'$'\n''Example:     isValidateType string || returnMessage 1 "string is not a type."'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'$'\n'''
# shellcheck disable=SC2016
helpPlain='Usage: isValidateType'$'\n'''$'\n''Are all arguments passed a valid validate type?'$'\n''Argument: --help - Flag. Optional. Display this help.'$'\n''Argument: type - String. Optional. Type to validate as validate type.'$'\n''Example:     isValidateType string || returnMessage 1 "string is not a type."'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 0.455
