...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mbuildCacheDirectory [[(blue)]m[ pathSegment ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]mpathSegment  [[(value)]mOne or more directory or file path, concatenated as path segments using [[(code)]m/[[(reset)]m[[(reset)]m'$'\n''    [[(blue)]m--help       [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Path to cache directory for build system.'$'\n''Defaults to [[(code)]m$XDG_CACHE_HOME/.build[[(reset)]m unless [[(code)]m$XDG_CACHE_HOME[[(reset)]m is not a directory.'$'\n''Appends any passed in arguments as path segments.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- XDG_CACHE_HOME'$'\n'''$'\n''Example:'$'\n''    logFile=$(buildCacheDirectory test.log)'$'\n'''
