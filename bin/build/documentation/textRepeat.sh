...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mtextRepeat [[(magenta)]m`count` [[(magenta)]m`text` .. [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mcount    UnsignedInteger. Required. Count of times to repeat.'$'\n''    [[(red)]mtext ..  String. Required. A sequence of characters to repeat.'$'\n''    [[(blue)]m--help     Flag. Optional. Display this help.'$'\n'''$'\n''Repeat a string'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Example:'$'\n''    textRepeat 80 ='$'\n''    decorate info Hello world'$'\n''    textRepeat 80 -'$'\n'''
