...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mdateToFormat [[(magenta)]mdate [[(blue)]m[ format ]'$'\n'''$'\n''    [[(red)]mdate    String. Required. String in the form YYYY-MM-DD (e.g. 2023-10-15)'$'\n''    [[(blue)]mformat  String. Optional. Format string for the date command (e.g. %s)'$'\n'''$'\n''Converts a date (YYYY-MM-DD) to another format.'$'\n''Compatible with BSD and GNU date.'$'\n'''$'\n''Return codes:'$'\n''- 1 - if parsing fails'$'\n''- 0 - if parsing succeeds'$'\n'''$'\n''Example:'$'\n''    dateToFormat 2023-04-20 %s 1681948800'$'\n''    timestamp=$(dateToFormat '\''2023-10-15'\'' %s)'$'\n'''
# elapsed 2.184
