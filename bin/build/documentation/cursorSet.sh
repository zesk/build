...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mcursorSet [[(magenta)]mx [[(magenta)]my'$'\n'''$'\n''    [[(red)]mx  [[(value)]mUnsignedInteger. Required. Column to place the cursor.'$'\n''    [[(red)]my  [[(value)]mUnsignedInteger. Required. Row to place the cursor.'$'\n'''$'\n''Move the cursor to x y'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
