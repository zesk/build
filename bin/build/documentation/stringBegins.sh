...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mstringBegins [[(bold)]m[[(magenta)]mhaystack [[(blue)]m[ needle ... ]'$'\n'''$'\n''    haystack    [[(value)]mString. Required. String to search.'$'\n''    [[(blue)]mneedle ...  [[(value)]mString. Optional. One or more strings to find as the "start" of haystack.'$'\n'''$'\n''Does needle exist as a substring of haystack?'$'\n'''$'\n''Return codes:'$'\n''- 0 - IFF ANY needle matches as a substring of haystack'$'\n''- 1 - No needles found in haystack'$'\n'''
# elapsed 2.519
