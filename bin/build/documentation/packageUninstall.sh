...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mpackageUninstall [[(bold)]mpackage [[(blue)]m[ --manager packageManager ]'$'\n'''$'\n''    [[(red)]mpackage                   [[(value)]mString. Required. One or more packages to uninstall'$'\n''    [[(blue)]m--manager packageManager  [[(value)]mString. Optional. Package manager to use. (apk, apt, brew)'$'\n'''$'\n''Removes packages using the current package manager.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Example:'$'\n''    packageUninstall shellcheck'$'\n'''
# elapsed 3.606
