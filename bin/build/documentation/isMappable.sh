...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]misMappable [[(blue)]m[ --help ] [[(blue)]m[ --prefix ] [[(blue)]m[ --suffix ] [[(blue)]m[ --token ] [[(blue)]m[ text ]'$'\n'''$'\n''    [[(blue)]m--help    [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--prefix  [[(value)]mString. Optional. Token prefix defaults to [[(code)]m{.'$'\n''    [[(blue)]m--suffix  [[(value)]mString. Optional. Token suffix defaults to [[(code)]m}.'$'\n''    [[(blue)]m--token   [[(value)]mString. Optional. Classes permitted in a token'$'\n''    [[(blue)]mtext      [[(value)]mString. Optional. Text to search for mapping tokens.'$'\n'''$'\n''Check if text contains mappable tokens'$'\n''If any text passed contains a token which can be mapped, succeed.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Text contains mapping tokens'$'\n''- [[(code)]m1 - Text does not contain mapping tokens'$'\n'''
