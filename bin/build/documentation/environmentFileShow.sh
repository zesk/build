...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: environmentFileShow [[(blue)]m[ environmentName ] [[(blue)]m[ -- ] [[(blue)]m[ optionalEnvironmentName ]'$'\n'''$'\n''    [[(red)]menvironmentName          [[(value)]mEnvironmentVariable. Optional. A required environment variable name'$'\n''    [[(blue)]m--                       [[(value)]mSeparator. Optional. Separates requires from optional environment variables'$'\n''    [[(blue)]moptionalEnvironmentName  [[(value)]mEnvironmentVariable. Optional. An optional environment variable name.'$'\n'''$'\n''Display and validate application variables.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m1 - If any required application variables are blank, the function fails with an environment error'$'\n''- [[(code)]m0 - All required application variables are non-blank'$'\n'''
# elapsed 3.516
