...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: environmentFileShow [ environmentName ] [ -- ] [ optionalEnvironmentName ]'$'\n'''$'\n''    environmentName          [[(value)]mEnvironmentVariable. Optional. A required environment variable name'$'\n''    --                       [[(value)]mSeparator. Optional. Separates requires from optional environment variables'$'\n''    optionalEnvironmentName  [[(value)]mEnvironmentVariable. Optional. An optional environment variable name.'$'\n'''$'\n''Display and validate application variables.'$'\n'''$'\n''Return codes:'$'\n''- 1 - If any required application variables are blank, the function fails with an environment error'$'\n''- 0 - All required application variables are non-blank'$'\n'''
# elapsed 2.342
