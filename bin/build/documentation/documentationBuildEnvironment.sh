...
# shellcheck disable=SC2016
helpPlain='Usage: documentationBuildEnvironment [[(blue)]m[ --documentation documentationPath ] [[(blue)]m[ --source sourcePath ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]m--documentation documentationPath  Directory. Optional. Path to documentation root. Default is ./documentation/source.'$'\n''    [[(blue)]m--source sourcePath                Directory. Optional. Path to source environment files. Defaults to $(buildHome)/bin/env if not specified.'$'\n''    [[(blue)]m--help                             Flag. Optional. Display this help.'$'\n'''$'\n''Build documentation for ./bin/env (or bin/build/env) directory.'$'\n''Creates a cache at documentationBuildCache'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Issue with environment'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.327
