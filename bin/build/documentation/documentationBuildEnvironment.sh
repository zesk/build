...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: documentationBuildEnvironment [[(blue)]m[ --documentation documentationPath ] [[(blue)]m[ --source sourcePath ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]m--documentation documentationPath  [[(value)]mDirectory. Optional. Path to documentation root. Default is ./documentation/source.'$'\n''    [[(blue)]m--source sourcePath                [[(value)]mDirectory. Optional. Path to source environment files. Defaults to $(buildHome)/bin/env if not specified.'$'\n''    [[(blue)]m--help                             [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Build documentation for ./bin/env (or bin/build/env) directory.'$'\n''Creates a cache at documentationBuildCache'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Issue with environment'$'\n''- 2 - Argument error'$'\n'''
