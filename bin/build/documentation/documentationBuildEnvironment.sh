...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdocumentationBuildEnvironment [ --documentation documentationPath ] [ --source sourcePath ] [ --help ]'$'\n'''$'\n''    --documentation documentationPath  [[(value)]mDirectory. Optional. Path to documentation root. Default is [[(code)]m./documentation/source.'$'\n''    --source sourcePath                [[(value)]mDirectory. Optional. Path to source environment files. Defaults to [[(code)]m$(buildHome)/bin/env if not specified.'$'\n''    --help                             [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Build documentation for ./bin/env (or bin/build/env) directory.'$'\n''Creates a cache at [[(code)]mdocumentationBuildCache'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Issue with environment'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 2.213
