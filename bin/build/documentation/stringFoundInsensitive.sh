...
fn="stringFoundInsensitive"
fnMarker="stringfoundinsensitive"
foundNames=([0]="argument" [1]="return_code" [2]="tested")
line="498"
original="stringFoundInsensitive"
