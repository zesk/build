...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mcatchReturn [[(bold)]mhandler [[(bold)]mbinary ...'$'\n'''$'\n''    handler     [[(value)]mFunction. Required. Error handler.'$'\n''    binary ...  [[(value)]mExecutable. Required. Any arguments are passed to [[(code)]mbinary.'$'\n'''$'\n''Run binary and catch errors with handler'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.339
