...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mfileIsOldest [[(magenta)]msourceFile [[(blue)]m[ targetFile ... ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]msourceFile      File. Required. File to check'$'\n''    [[(blue)]mtargetFile ...  File. Optional. One or more files to compare. All must exist.'$'\n''    [[(blue)]m--help          Flag. Optional. Display this help.'$'\n'''$'\n''Check to see if the first file is the newest one'$'\n''If sourceFile is modified AFTER ALL targetFiles, return 0'$'\n''Otherwise return 1'$'\n'''$'\n''Return codes:'$'\n''- 1 - sourceFile, '\''targetFile'\'' does not exist, or'$'\n''- 0 - All files exist and sourceFile is the oldest file'$'\n'''
# elapsed 0.632
