...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: mariadbConnect [[(blue)]m[ dsn ] [[(blue)]m[ binary ] [[(blue)]m[ --print ]'$'\n'''$'\n''    [[(blue)]mdsn      [[(value)]mURL. Database to connect to. All arguments after this are passed to [[(code)]mbinary.'$'\n''    [[(blue)]mbinary   [[(value)]mCallable. Executable to connect to the database.'$'\n''    [[(blue)]m--print  [[(value)]mFlag. Optional. Just print the statement instead of running it.'$'\n'''$'\n''Connect to a mariadb-type database using a URL'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- MARIADB_BINARY_CONNECT'$'\n'''
