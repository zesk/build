...
# shellcheck disable=SC2016
helpPlain='Usage: mapValueTrim mapFile [ value ]'$'\n'''$'\n''    mapFile  [[(value)]mFile. Required. a file containing bash environment definitions'$'\n''    value    [[(value)]mString. Optional. One or more values to map using said environment file.'$'\n'''$'\n''Maps a string using an environment file'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.872
