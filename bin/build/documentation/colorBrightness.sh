...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mcolorBrightness [[(blue)]m[ --help ] [[(blue)]m[ redValue ] [[(blue)]m[ greenValue ] [[(blue)]m[ blueValue ]'$'\n'''$'\n''    [[(blue)]m--help      [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]mredValue    [[(value)]mInteger. Optional. Red RGB value (0-255)'$'\n''    [[(blue)]mgreenValue  [[(value)]mInteger. Optional. Red RGB value (0-255)'$'\n''    [[(blue)]mblueValue   [[(value)]mInteger. Optional. Red RGB value (0-255)'$'\n'''$'\n''Return an integer between 0 and 100'$'\n''Colors are between 0 and 255'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Reads from stdin:'$'\n''3 integer values [ Optional ]'$'\n'''
