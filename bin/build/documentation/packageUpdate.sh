...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mpackageUpdate [[(blue)]m[ --help ] [[(blue)]m[ --verbose ] [[(blue)]m[ --manager packageManager ] [[(blue)]m[ --force ]'$'\n'''$'\n''    [[(blue)]m--help                    [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--verbose                 [[(value)]mFlag. Optional. Display progress to the terminal.'$'\n''    [[(blue)]m--manager packageManager  [[(value)]mString. Optional. Package manager to use. (apk, apt, brew)'$'\n''    [[(blue)]m--force                   [[(value)]mFlag. Optional. Force even if it was updated recently.'$'\n'''$'\n''Update packages lists and sources'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
