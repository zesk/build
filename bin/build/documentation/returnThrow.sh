...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mreturnThrow [[(magenta)]mreturnCode [[(magenta)]mhandler [[(blue)]m[ message ... ]'$'\n'''$'\n''    [[(red)]mreturnCode   [[(value)]mInteger. Required. Return code.'$'\n''    [[(red)]mhandler      [[(value)]mFunction. Required. Error handler.'$'\n''    [[(blue)]mmessage ...  [[(value)]mString. Optional. Error message'$'\n'''$'\n''Run [[(code)]mhandler with a passed return code'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
