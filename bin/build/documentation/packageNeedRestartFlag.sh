...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mpackageNeedRestartFlag [[(blue)]m[ value ]'$'\n'''$'\n''    [[(blue)]mvalue  [[(value)]mSet the restart flag to this value (blank to remove)'$'\n'''$'\n''INTERNAL - has [[(code)]mpackageUpdate set the [[(code)]mrestart flag at some point?'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.581
