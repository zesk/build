...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mpackageNeedRestartFlag [[(blue)]m[ value ]'$'\n'''$'\n''    [[(blue)]mvalue  [[(value)]mSet the restart flag to this value (blank to remove)[[(reset)]m'$'\n'''$'\n''INTERNAL - has [[(code)]mpackageUpdate[[(reset)]m set the [[(code)]mrestart[[(reset)]m flag at some point?'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
# elapsed 2.359
