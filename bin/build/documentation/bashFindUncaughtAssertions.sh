...
helpConsole='no helpPlain in bin/build/documentation/bashFindUncaughtAssertions.sh'$'\n'''
# shellcheck disable=SC2016
helpPlain='no helpPlain in bin/build/documentation/bashFindUncaughtAssertions.sh'$'\n'''
