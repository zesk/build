...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mreleaseNotes [[(blue)]m[ --application application ] [[(blue)]m[ version ]'$'\n'''$'\n''    [[(blue)]m--application application  [[(value)]mDirectory. Optional. Application home directory.'$'\n''    [[(blue)]mversion                    [[(value)]mString. Optional. Version for the release notes path. If not specified uses the current version.'$'\n'''$'\n''Output path to current release notes'$'\n''If this fails it outputs an error to stderr'$'\n''When this tool succeeds it outputs the path to the current release notes file'$'\n''shellcheck disable=SC2120'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- BUILD_RELEASE_NOTES'$'\n'''$'\n''Example:'$'\n''    open $(bin/build/release-notes.sh)'$'\n''    vim $(releaseNotes)'$'\n'''
# elapsed 2.178
