...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mbashLintFilesInteractive [[(blue)]m[ --exec binary ] [[(blue)]m[ --delay delaySeconds ] [[(blue)]m[ fileToCheck ... ]'$'\n'''$'\n''    [[(blue)]m--exec binary         [[(value)]mCallable. Optional. Run binary with files as an argument for any failed files. Only works if you pass in item names.'$'\n''    [[(blue)]m--delay delaySeconds  [[(value)]mInteger. Optional. Delay in seconds between checks in interactive mode.'$'\n''    [[(blue)]mfileToCheck ...       [[(value)]mFile. Optional. Shell file to validate.'$'\n'''$'\n''Run checks interactively until errors are all fixed.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.658
