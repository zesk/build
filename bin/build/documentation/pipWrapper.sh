...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mpipWrapper [[(blue)]m[ --bin binary ] [[(blue)]m[ --handler handler ] [[(blue)]m[ --help ] [[(blue)]m[ --debug ] [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(blue)]m--bin binary       [[(value)]mExecutable. Optional. Binary for [[(code)]mpip.'$'\n''    [[(blue)]m--handler handler  [[(value)]mFunction. Optional. Use this error handler instead of the default error handler.'$'\n''    [[(blue)]m--help             [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--debug            [[(value)]mFlag. Optional. Show outputs to [[(code)]mwhich and [[(code)]mcommand -v for [[(code)]mpip'$'\n''    [[(blue)]m...                [[(value)]mArguments. Optional. Arguments passed to [[(code)]mpip'$'\n'''$'\n''Run pip whether it is installed as a module or as a binary'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 2.889
