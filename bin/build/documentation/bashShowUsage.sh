...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mbashShowUsage [[(bold)]m[[(magenta)]mfunctionName [[(bold)]m[[(magenta)]mfile [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mfunctionName  [[(value)]mString. Required. Function which should be called somewhere within a file.[[(reset)]m'$'\n''    [[(red)]mfile          [[(value)]mFile. Required. File to search for function handler.[[(reset)]m'$'\n''    [[(blue)]m--help        [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Show function handler in files'$'\n''This check is simplistic and does not verify actual coverage or code paths.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Function is used within the file'$'\n''- [[(code)]m1[[(reset)]m - Function is [[(cyan)]mnot[[(reset)]m used within the file'$'\n'''
# elapsed 0.775
