...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: awsCredentialsRemove [[(blue)]m[ --profile profileName ] [[(blue)]m[ --comments ] [[(blue)]m[ profileName ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]m--profile profileName  String. Optional. The credentials profile to remove.'$'\n''    [[(blue)]m--comments             Flag. Optional. Write comments to the credentials file (in addition to updating the record).'$'\n''    [[(blue)]mprofileName            String. Optional. The credentials profile to remove.'$'\n''    [[(blue)]m--help                 Flag. Optional. Display this help.'$'\n'''$'\n''Remove credentials from the AWS credentials file'$'\n''If the AWS credentials file is not found, succeeds.'$'\n''You can supply the profile using the --profile or directly, but just one.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.566
