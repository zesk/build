...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mawsCredentialsRemove [ --profile profileName ] [ --comments ] [ profileName ] [ --help ]'$'\n'''$'\n''    --profile profileName  [[(value)]mString. Optional. The credentials profile to remove.'$'\n''    --comments             [[(value)]mFlag. Optional. Write comments to the credentials file (in addition to updating the record).'$'\n''    profileName            [[(value)]mString. Optional. The credentials profile to remove.'$'\n''    --help                 [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Remove credentials from the AWS credentials file'$'\n''If the AWS credentials file is not found, succeeds.'$'\n''You can supply the profile using the [[(code)]m--profile or directly, but just one.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 2.552
