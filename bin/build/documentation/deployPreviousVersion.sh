...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mdeployPreviousVersion [[(magenta)]mdeployHome [[(magenta)]mversionName'$'\n'''$'\n''    [[(red)]mdeployHome   Directory. Required. Deployment database home.'$'\n''    [[(red)]mversionName  String. Required. Application ID to look for'$'\n'''$'\n''Get the previous version of the supplied version'$'\n'''$'\n''Return codes:'$'\n''- 1 - No version exists'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.263
