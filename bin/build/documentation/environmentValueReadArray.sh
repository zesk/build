...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]menvironmentValueReadArray [[(magenta)]mstateFile [[(magenta)]mname [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mstateFile  [[(value)]mFile. Required. File to access, must exist.'$'\n''    [[(red)]mname       [[(value)]mEnvironmentVariable. Required. Name to read.'$'\n''    [[(blue)]m--help     [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Read an array value from a state file'$'\n''Outputs array elements, one per line.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
