...
usage="applicationHomeAliases"
# shellcheck disable=SC2016
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]mapplicationHomeAliases'$'\e''[0m'$'\n'''$'\n''Set aliases '$'\e''[[(code)]mG'$'\e''[[(reset)]m and '$'\e''[[(code)]mg'$'\e''[[(reset)]m default for '$'\e''[[(code)]mapplicationHome'$'\e''[[(reset)]m'$'\n''Localize as you wish for your own shell'$'\n''Argument: goAlias - String. Alias for '$'\e''[[(code)]mapplicationHome --go'$'\e''[[(reset)]m. Default is '$'\e''[[(code)]mg'$'\e''[[(reset)]m.'$'\n''Argument: setAlias - String. Alias for '$'\e''[[(code)]mapplicationHome'$'\e''[[(reset)]m. Default is '$'\e''[[(code)]mG'$'\e''[[(reset)]m.'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'$'\n'''
# shellcheck disable=SC2016
helpPlain='Usage: applicationHomeAliases'$'\n'''$'\n''Set aliases G and g default for applicationHome'$'\n''Localize as you wish for your own shell'$'\n''Argument: goAlias - String. Alias for applicationHome --go. Default is g.'$'\n''Argument: setAlias - String. Alias for applicationHome. Default is G.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 0.455
