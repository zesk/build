...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mbashFunctionDefined [[(bold)]m[[(magenta)]mfunctionName [[(bold)]m[[(magenta)]mfile ... [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mfunctionName  [[(value)]mString. Required. Name of function to check.'$'\n''    [[(red)]mfile ...      [[(value)]mFile. Required. One or more files to check if a function is defined within.'$'\n''    [[(blue)]m--help        [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Is a function defined in a bash source file?'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.626
