...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mstringOffsetInsensitive [[(bold)]m[[(magenta)]mneedle [[(bold)]m[[(magenta)]mhaystack'$'\n'''$'\n''    [[(red)]mneedle    [[(value)]mString. Required.[[(reset)]m'$'\n''    [[(red)]mhaystack  [[(value)]mString. Required.[[(reset)]m'$'\n'''$'\n''Outputs the integer offset of [[(code)]mneedle[[(reset)]m if found as substring in [[(code)]mhaystack[[(reset)]m (case-insensitive)'$'\n''If [[(code)]mhaystack[[(reset)]m is not found, -1 is output'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Writes to [[(code)]mstdout[[(reset)]m:'$'\n''[[(code)]mInteger[[(reset)]m. The offset at which the [[(code)]mneedle[[(reset)]m was found in [[(code)]mhaystack[[(reset)]m. Outputs -1 if not found.'$'\n'''
# elapsed 3.159
