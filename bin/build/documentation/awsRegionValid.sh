...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mawsRegionValid [[(bold)]m[[(magenta)]mregion ... [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mregion ...  [[(value)]mString. Required. The AWS Region to validate.'$'\n''    [[(blue)]m--help      [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Checks an AWS region identifier for validity as of September 2024.'$'\n''Note that passing no parameters returns success.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - All regions are valid AWS region'$'\n''- [[(code)]m1 - One or more regions are NOT a valid AWS region'$'\n'''
# elapsed 2.241
