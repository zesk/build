...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mstringBeginsInsensitive [[(bold)]m[[(magenta)]mhaystack [[(blue)]m[ needle ... ]'$'\n'''$'\n''    haystack    [[(value)]mString. Required. String to search. (case-insensitive)'$'\n''    [[(blue)]mneedle ...  [[(value)]mString. Optional. One or more strings to find as the "start" of haystack (case-insensitive)'$'\n'''$'\n''Does needle exist as a substring of haystack? (case-insensitive)'$'\n'''$'\n''Return codes:'$'\n''- 0 - IFF ANY needle matches as a substring of haystack (case-insensitive)'$'\n''- 1 - No needles found in haystack (case-insensitive)'$'\n'''
# elapsed 2.563
