...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mtools [[(blue)]m[ --help ] [[(blue)]m[ --start startDirectory ] [[(blue)]m[ --verbose ] [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(blue)]m--help                  [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--start startDirectory  [[(value)]mDirectory. Optional. Start searching for a build installation at this location and searching upwards in the file hierarchy.'$'\n''    [[(blue)]m--verbose               [[(value)]mFlag. Optional. Be verbose.'$'\n''    [[(blue)]m...                     [[(value)]mCallable. Optional. Run this command after loading in the current build context.'$'\n'''$'\n''Run a Zesk Build command or load it'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
