...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdirectoryParent [[(magenta)]mstartingDirectory [[(magenta)]m--pattern filePattern [ --test testExpression ]'$'\n'''$'\n''    [[(red)]mstartingDirectory      Required. EmptyString|RealDirectory. Uses the current directory if blank.'$'\n''    [[(red)]m--pattern filePattern  RelativePath. Required. The file or directory to find the home for.'$'\n''    --test testExpression  String. Optional. Zero or more. The test argument to test the targeted filePattern. By default uses -d.'$'\n'''$'\n''Finds a file above startingDirectory, uses testExpression to test (defaults to -d)'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
