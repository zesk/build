...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdirectoryParent [[(bold)]m[[(magenta)]mstartingDirectory [[(bold)]m[[(magenta)]m--pattern filePattern [[(blue)]m[ --test testExpression ]'$'\n'''$'\n''    [[(red)]mstartingDirectory      [[(value)]mRequired. EmptyString|RealDirectory. Uses the current directory if blank.[[(reset)]m'$'\n''    [[(red)]m--pattern filePattern  [[(value)]mRelativePath. Required. The file or directory to find the home for.[[(reset)]m'$'\n''    [[(blue)]m--test testExpression  [[(value)]mString. Optional. Zero or more. The [[(code)]mtest[[(reset)]m argument to test the targeted [[(code)]mfilePattern[[(reset)]m. By default uses [[(code)]m-d[[(reset)]m.[[(reset)]m'$'\n'''$'\n''Finds a file above [[(code)]mstartingDirectory[[(reset)]m, uses [[(code)]mtestExpression[[(reset)]m to test (defaults to [[(code)]m-d[[(reset)]m)'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
