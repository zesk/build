...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: aptKeyAdd [[(blue)]m[ --title keyTitle ] [[(magenta)]m--name keyName [[(magenta)]m--url remoteUrl [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]m--title keyTitle  String. Optional. Title of the key.'$'\n''    --name keyName    String. Required. Name of the key used to generate file names.'$'\n''    --url remoteUrl   URL. Required. Remote URL of gpg key.'$'\n''    [[(blue)]m--help            Flag. Optional. Display this help.'$'\n'''$'\n''Add keys to enable apt to download terraform directly from hashicorp.com'$'\n'''$'\n''Return codes:'$'\n''- 1 - if environment is awry'$'\n''- 0 - Apt key is installed AOK'$'\n'''
