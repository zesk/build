...
# shellcheck disable=SC2016
helpPlain='Usage: textAlignLeft [[(blue)]m[ --help ] [[(magenta)]mcharacterWidth [[(blue)]m[ text ... ]'$'\n'''$'\n''    [[(blue)]m--help          Flag. Optional. Display this help.'$'\n''    [[(red)]mcharacterWidth  UnsignedInteger. Required. Number of characters to align left'$'\n''    [[(blue)]mtext ...        Text to align left.'$'\n'''$'\n''Format text and align it left using spaces.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Example:'$'\n''    printf "%s: %s\n" "$(textAlignLeft 14 Name)" "$name"'$'\n''    printf "%s: %s\n" "$(textAlignLeft 14 Profession)" "$occupation"'$'\n''    Name          : Tyrone'$'\n''    Profession    : Engineer'$'\n'''
