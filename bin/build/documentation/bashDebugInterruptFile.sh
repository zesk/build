...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mbashDebugInterruptFile [[(blue)]m[ --help ] [[(blue)]m[ --error ] [[(blue)]m[ --interrupt ]'$'\n'''$'\n''    [[(blue)]m--help       [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--error      [[(value)]mFlag. Add ERR trap.'$'\n''    [[(blue)]m--interrupt  [[(value)]mFlag. Add INT trap.'$'\n'''$'\n''Adds a trap to capture the debugging stack on interrupt'$'\n''Use this in a bash script which runs forever or runs in an infinite loop to'$'\n''determine where the problem or loop exists.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
