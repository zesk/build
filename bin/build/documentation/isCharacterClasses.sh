...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]misCharacterClasses [[(bold)]m[[(magenta)]mcharacter [[(blue)]m[ class ... ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mcharacter  [[(value)]mRequired. Single character to test.[[(reset)]m'$'\n''    [[(blue)]mclass ...  [[(value)]mString. Optional. A class name or a character to match. If more than is supplied, a single value must match to succeed (any).[[(reset)]m'$'\n''    [[(blue)]m--help     [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Does this character match one or more character classes?'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
