...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]midenticalFindTokens [[(magenta)]m--prefix prefix [[(magenta)]mfile ...'$'\n'''$'\n''    [[(red)]m--prefix prefix  String. Required. A text prefix to search for to identify identical sections (e.g. # IDENTICAL) (may specify more than one)'$'\n''    [[(red)]mfile ...         File. Required. A file to search for identical tokens.'$'\n'''$'\n''No documentation for identicalFindTokens.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Writes to stdout:'$'\n''tokens, one per line'$'\n'''
# elapsed 3.751
