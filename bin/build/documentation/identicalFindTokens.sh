...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]midenticalFindTokens [[(bold)]m[[(magenta)]m--prefix prefix [[(bold)]m[[(magenta)]mfile ...'$'\n'''$'\n''    [[(red)]m--prefix prefix  [[(value)]mString. Required. A text prefix to search for to identify identical sections (e.g. [[(code)]m# IDENTICAL) (may specify more than one)'$'\n''    [[(red)]mfile ...         [[(value)]mFile. Required. A file to search for identical tokens.'$'\n'''$'\n''No documentation for [[(code)]midenticalFindTokens.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''tokens, one per line'$'\n'''
