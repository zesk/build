...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mbashCommentFilter [[(blue)]m[ --help ] [[(blue)]m[ --only ] [[(blue)]m[ file ]'$'\n'''$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]m--only  [[(value)]mFlag. Optional. Show ONLY comment lines. (Reverse of lines when not specified.)'$'\n''    [[(blue)]mfile    [[(value)]mFile. Optional. File(s) to filter.'$'\n'''$'\n''Filter comments from a bash stream'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin:'$'\n''a bash file'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''bash file without line-comments [[(code)]m#'$'\n'''
# elapsed 0.727
