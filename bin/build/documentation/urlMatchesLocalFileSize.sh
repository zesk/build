...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]murlMatchesLocalFileSize [ --help ] [[(magenta)]murl [[(magenta)]mfile'$'\n'''$'\n''    --help  [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(red)]murl     [[(value)]mURL. Required. URL to check.'$'\n''    [[(red)]mfile    [[(value)]mFile. Required. File to compare.'$'\n'''$'\n''Compare a remote file size with a local file size'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 2.222
