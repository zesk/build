...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]menvironmentParseVariables [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Parse variables from an environment variable stream'$'\n''Extracts lines with [[(code)]mNAME=value[[(reset)]m'$'\n''Details:'$'\n''- Remove [[(code)]mexport [[(reset)]m from lines'$'\n''- Skip lines containing [[(code)]mread -r[[(reset)]m'$'\n''- Anything before a [[(code)]m=[[(reset)]m is considered a variable name'$'\n''- Returns a sorted, unique list'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin[[(reset)]m:'$'\n''Environment File'$'\n'''$'\n''Writes to [[(code)]mstdout[[(reset)]m:'$'\n''EnvironmentVariable. One per line.'$'\n'''
# elapsed 3.366
