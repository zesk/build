...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mjunitTestCaseOpen'$'\n'''$'\n''Open tag for [[(code)]mtestcase[[(reset)]m - Test case'$'\n''- [[(code)]mname=testCase1[[(reset)]m'$'\n''- [[(code)]mclassname=Tests.Registration[[(reset)]m'$'\n''- [[(code)]massertions=2[[(reset)]m'$'\n''- [[(code)]mtime=2.436[[(reset)]m'$'\n''- [[(code)]mfile=tests/registration.code[[(reset)]m'$'\n''- [[(code)]mline=24[[(reset)]m'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Example:'$'\n''    <testcase name="testCase1" classname="Tests.Registration" assertions="2"'$'\n''        time="2.436" file="tests/registration.code" line="24"/>'$'\n'''
