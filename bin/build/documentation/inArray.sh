...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: inArray [[(blue)]m[ element ] [[(blue)]m[ arrayElement0 ... ]'$'\n'''$'\n''    [[(blue)]melement            [[(value)]mEmptyString. Thing to search for'$'\n''    [[(blue)]marrayElement0 ...  [[(value)]mArray. Optional. One or more array elements to match'$'\n'''$'\n''Check if an element exists in an array'$'\n''Without arguments, displays help.'$'\n'''$'\n''Return codes:'$'\n''- 0 - If element is found in array'$'\n''- 1 - If element is NOT found in array'$'\n'''$'\n''Example:'$'\n''    if inArray "$thing" "${things[@]+"${things[@]}"}"; then'$'\n''        things+=("$thing")'$'\n''    fi'$'\n'''
# elapsed 3.335
