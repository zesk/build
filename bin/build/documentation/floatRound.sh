...
argument="none"
base="float.sh"
description="Argument: number - Float. Optional. Floating point number to convert to integer."$'\n'"Convert float to nearest integer (up or down)"$'\n'""
...
summary="Argument: number - Float. Optional. Floating point number to convert"
usage="floatRound"
# shellcheck disable=SC2016
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]mfloatRound'$'\e''[0m'$'\n'''$'\n''Argument: number - Float. Optional. Floating point number to convert to integer.'$'\n''Convert float to nearest integer (up or down)'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'$'\n'''
# shellcheck disable=SC2016
helpPlain='Usage: floatRound'$'\n'''$'\n''Argument: number - Float. Optional. Floating point number to convert to integer.'$'\n''Convert float to nearest integer (up or down)'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 0.465
