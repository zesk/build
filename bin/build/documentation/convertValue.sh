...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: convertValue [[(blue)]m[ --help ] [[(blue)]m[ value ] [[(blue)]m[ from ] [[(blue)]m[ to ] [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]mvalue   [[(value)]mString. A value.'$'\n''    [[(blue)]mfrom    [[(value)]mString. When value matches from, instead print to'$'\n''    [[(blue)]mto      [[(value)]mString. The value to print when from matches value'$'\n''    [[(blue)]m...     [[(value)]mString. Optional. Additional from-to pairs can be passed, first matching value is used, all values will be examined if none match'$'\n'''$'\n''map a value from one value to another given from-to pairs'$'\n''Prints the mapped value to stdout'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.182
