...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mconvertValue [[(blue)]m[ --help ] [[(blue)]m[ value ] [[(blue)]m[ from ] [[(blue)]m[ to ] [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(blue)]m--help  Flag. Optional. Display this help.'$'\n''    [[(blue)]mvalue   String. A value.'$'\n''    [[(blue)]mfrom    String. When value matches from, instead print to'$'\n''    [[(blue)]mto      String. The value to print when from matches value'$'\n''    [[(blue)]m...     String. Optional. Additional from-to pairs can be passed, first matching value is used, all values will be examined if none match'$'\n'''$'\n''map a value from one value to another given from-to pairs'$'\n''Prints the mapped value to stdout'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
