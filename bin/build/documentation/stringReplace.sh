...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mstringReplace [[(bold)]m[[(magenta)]mneedle [[(blue)]m[ replacement ] [[(blue)]m[ haystack ]'$'\n'''$'\n''    [[(red)]mneedle       [[(value)]mString. Required. String to replace.'$'\n''    [[(blue)]mreplacement  [[(value)]mEmptyString.  String to replace needle with.'$'\n''    [[(blue)]mhaystack     [[(value)]mEmptyString. Optional. String to modify. If not supplied, reads from standard input.'$'\n'''$'\n''Replace all occurrences of a string within another string'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin:'$'\n''If no haystack supplied reads from standard input and replaces the string on each line read.'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''New string with needle replaced'$'\n'''
