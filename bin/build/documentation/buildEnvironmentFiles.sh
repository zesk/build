...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mbuildEnvironmentFiles [[(blue)]m[ envName ] [[(blue)]m[ --application applicationHome ] [[(blue)]m[ --help ] [[(blue)]m[ --handler handler ]'$'\n'''$'\n''    [[(blue)]menvName                        [[(value)]mString. Optional. Name of the environment value to find[[(reset)]m'$'\n''    [[(blue)]m--application applicationHome  [[(value)]mPath. Optional. Directory of alternate application home. Can be specified more than once to change state.[[(reset)]m'$'\n''    [[(blue)]m--help                         [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n''    [[(blue)]m--handler handler              [[(value)]mFunction. Optional. Use this error handler instead of the default error handler.[[(reset)]m'$'\n'''$'\n''Determine the environment file names for environment variables'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- BUILD_ENVIRONMENT_DIRS'$'\n'''
# elapsed 3.043
