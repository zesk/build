...
description="shellcheck disable=SC2120"$'\n'""
environment="None."$'\n'""
...
summary="shellcheck disable=SC2120"
...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mmapTokens [[(blue)]m[ `prefix` ] [[(blue)]m[ `suffix` ]'$'\n'''$'\n''    [[(blue)]m[[(code)]mprefix[[(reset)]m  [[(value)]mOptional prefix for token search, defaults to [[(code)]m{[[(reset)]m (same as [[(code)]mmap.sh[[(reset)]m)[[(reset)]m'$'\n''    [[(blue)]m[[(code)]msuffix[[(reset)]m  [[(value)]mOptional suffix for token search, defaults to [[(code)]m}[[(reset)]m (same as [[(code)]mmap.sh[[(reset)]m)[[(reset)]m'$'\n'''$'\n''shellcheck disable=SC2120'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Environment variables:'$'\n''- None.'$'\n'''
# elapsed 4.293
