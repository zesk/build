...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]misDockerComposeCommand [[(magenta)]mcommand [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mcommand  [[(value)]mString. Required. The command to test.'$'\n''    [[(blue)]m--help   [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Is this a docker compose command?'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Yes, it is.'$'\n''- [[(code)]m1 - No, it is not.'$'\n'''
# elapsed 3.579
