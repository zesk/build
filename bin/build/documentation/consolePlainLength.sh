...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: consolePlainLength [[(blue)]m[ text ]'$'\n'''$'\n''    [[(blue)]mtext  [[(value)]mEmptyString. Optional. text to determine the plaintext length of. If not supplied reads from standard input.'$'\n'''$'\n''Length of an unformatted string'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Reads from stdin:'$'\n''A file to determine the plain-text length'$'\n'''$'\n''Writes to stdout:'$'\n''UnsignedInteger. Length of the plain characters in the input arguments.'$'\n'''
