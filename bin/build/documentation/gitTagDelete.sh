...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mgitTagDelete [[(blue)]m[ --help ] [[(blue)]m[ tag ]'$'\n'''$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n''    [[(blue)]mtag     [[(value)]mThe tag to delete locally and at origin[[(reset)]m'$'\n'''$'\n''Delete git tag locally and at origin'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]margument[[(reset)]m - Any stage fails will result in this exit code. Partial deletion may occur.'$'\n'''
