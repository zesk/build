...
base="DAEMONTOOLS_HOME.sh"
category="Vendor"
derivations=([0]="env" [1]="envMarker")
description=$'Constant for the directory where services are monitored by daemontools\n\n'
descriptionLineCount="2"
env="DAEMONTOOLS_HOME"
envMarker="daemontools_home"
file="bin/build/env/DAEMONTOOLS_HOME.sh"
fn="DAEMONTOOLS_HOME"
foundNames=([0]="category" [1]="vendor" [2]="type")
rawComment=$'Constant for the directory where services are monitored by daemontools\nCategory: Vendor\nVendor: Daemontools\nType: Directory\n\n'
