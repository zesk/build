...
envMarker="bitbucket_repo_slug"
file="bin/build/env/BITBUCKET_REPO_SLUG.sh"
fn="BITBUCKET_REPO_SLUG"
foundNames=([0]="category" [1]="vendor" [2]="type")
rawComment="Defined in BITBUCKET Pipelines, represents the project code name."$'\n'"Category: Continuous Integration"$'\n'"Vendor: BitBucket"$'\n'"Type: String"$'\n'""$'\n'""
