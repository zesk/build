...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]msedReplacePattern [[(bold)]m[[(magenta)]msearchPattern [[(bold)]m[[(magenta)]mreplacePattern'$'\n'''$'\n''    [[(red)]msearchPattern   [[(value)]mString. Required. The string to search for.[[(reset)]m'$'\n''    [[(red)]mreplacePattern  [[(value)]mString. Required. The replacement to replace with.[[(reset)]m'$'\n'''$'\n''Quote a sed command for search and replace'$'\n''Without arguments, displays help.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
# elapsed 4.317
