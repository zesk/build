...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: isCallable [[(bold)]m[[(magenta)]mstring'$'\n'''$'\n''    [[(red)]mstring  [[(value)]mEmptyString. Required. Path to binary to test if it is executable.'$'\n'''$'\n''Test if all arguments are callable as a command'$'\n''If no arguments are passed, returns exit code 1.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - All arguments are callable as a command'$'\n''- [[(code)]m1 - One or or more arguments are callable as a command'$'\n'''
