...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]murlFilter [[(blue)]m[ --show-file ] [[(blue)]m[ --file name ] [[(blue)]m[ file ]'$'\n'''$'\n''    [[(blue)]m--show-file  [[(value)]mBoolean. Optional. Show the file name in the output (suffix with [[(code)]m: [[(reset)]m)[[(reset)]m'$'\n''    [[(blue)]m--file name  [[(value)]mString. Optional. The file name to display - can be any text.[[(reset)]m'$'\n''    [[(blue)]mfile         [[(value)]mFile. Optional. A file to read and output URLs found.[[(reset)]m'$'\n'''$'\n''Open URLs which appear in a stream'$'\n''Takes a text file and outputs any [[(code)]mhttps://[[(reset)]m or [[(code)]mhttp://[[(reset)]m URLs found within.'$'\n''URLs are explicitly trimmed at quote, whitespace and escape boundaries.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin[[(reset)]m:'$'\n''text'$'\n'''$'\n''Writes to [[(code)]mstdout[[(reset)]m:'$'\n''line:URL'$'\n'''
