...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]murlFilter [[(blue)]m[ --show-file ] [[(blue)]m[ --file name ] [[(blue)]m[ file ]'$'\n'''$'\n''    [[(blue)]m--show-file  [[(value)]mBoolean. Optional. Show the file name in the output (suffix with [[(code)]m: )'$'\n''    [[(blue)]m--file name  [[(value)]mString. Optional. The file name to display - can be any text.'$'\n''    [[(blue)]mfile         [[(value)]mFile. Optional. A file to read and output URLs found.'$'\n'''$'\n''Open URLs which appear in a stream'$'\n''Takes a text file and outputs any [[(code)]mhttps:// or [[(code)]mhttp:// URLs found within.'$'\n''URLs are explicitly trimmed at quote, whitespace and escape boundaries.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin:'$'\n''text'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''line:URL'$'\n'''
