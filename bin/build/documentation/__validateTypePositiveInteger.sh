...
description=$'No documentation for `__validateTypePositiveInteger`.\n'
descriptionLineCount=""
file="bin/build/install.sample.sh"
fn="__validateTypePositiveInteger"
fnMarker="__validatetypepositiveinteger"
foundNames=([0]="requires")
line="745"
original="__validateTypePositiveInteger"
rawComment=$'Requires: isPositiveInteger _validateThrow\n\n'
...
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]m__validateTypePositiveInteger'$'\e''[0m'$'\n'''$'\n''No documentation for '$'\e''[[(code)]m__validateTypePositiveInteger'$'\e''[[(reset)]m.'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'
# shellcheck disable=SC2016
helpPlain='Usage: __validateTypePositiveInteger'$'\n'''$'\n''No documentation for __validateTypePositiveInteger.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'
documentationPath=""
