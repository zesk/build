...
usage="dotFilesApproved"
# shellcheck disable=SC2016
helpConsole=''$'\e''[[(label)]mUsage'$'\e''[0m: '$'\e''[[(info)]mdotFilesApproved'$'\e''[0m'$'\n'''$'\n''Lists of dot files which can be added to the dotFilesApprovedFile'$'\n''Argument: listType - String. Optional. One of '$'\e''[[(code)]mall'$'\e''[[(reset)]m, '$'\e''[[(code)]mbash'$'\e''[[(reset)]m, '$'\e''[[(code)]mgit'$'\e''[[(reset)]m, '$'\e''[[(code)]mdarwin'$'\e''[[(reset)]m, or '$'\e''[[(code)]mmysql'$'\e''[[(reset)]m'$'\n''If none specified, returns '$'\e''[[(code)]mbash'$'\e''[[(reset)]m list.'$'\n''Special value '$'\e''[[(code)]mall'$'\e''[[(reset)]m returns all values'$'\n'''$'\n''Return codes:'$'\n''- '$'\e''[[(code)]m0'$'\e''[[(reset)]m - Success'$'\n''- '$'\e''[[(code)]m1'$'\e''[[(reset)]m - Environment error'$'\n''- '$'\e''[[(code)]m2'$'\e''[[(reset)]m - Argument error'$'\n'''
# shellcheck disable=SC2016
helpPlain='Usage: dotFilesApproved'$'\n'''$'\n''Lists of dot files which can be added to the dotFilesApprovedFile'$'\n''Argument: listType - String. Optional. One of all, bash, git, darwin, or mysql'$'\n''If none specified, returns bash list.'$'\n''Special value all returns all values'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 0.499
