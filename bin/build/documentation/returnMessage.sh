...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mreturnMessage [[(bold)]m[[(magenta)]mexitCode [[(blue)]m[ message ... ]'$'\n'''$'\n''    [[(red)]mexitCode     [[(value)]mUnsignedInteger. Required. Exit code to return. Default is 1.'$'\n''    [[(blue)]mmessage ...  [[(value)]mString. Optional. Message to output'$'\n'''$'\n''Return passed in integer return code and output message to [[(code)]mstderr (non-zero) or [[(code)]mstdout (zero)'$'\n'''$'\n''Return codes:'$'\n''- exitCode'$'\n'''
