...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: newlineHide [[(blue)]m[ --help ] [[(magenta)]mtext [[(blue)]m[ replace ]'$'\n'''$'\n''    [[(blue)]m--help   [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(red)]mtext     [[(value)]mString. Required. Text to replace.'$'\n''    [[(blue)]mreplace  [[(value)]mString. Optional. Replacement string for newlines.'$'\n'''$'\n''Hide newlines in text (to ensure single-line output or other manipulation)'$'\n''Without arguments, displays help.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''$'\n''Writes to stdout:'$'\n''The text with the newline replaced with another character, suitable typically for single-line output'$'\n'''
