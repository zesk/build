...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdirectoryChange [[(bold)]m[[(magenta)]mdirectory [[(bold)]m[[(magenta)]mcommand [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(red)]mdirectory  [[(value)]mDirectory. Required. Directory to change to prior to running command.[[(reset)]m'$'\n''    [[(red)]mcommand    [[(value)]mCallable. Required. Thing to do in this directory.[[(reset)]m'$'\n''    [[(blue)]m...        [[(value)]mArguments. Optional. Arguments to [[(code)]mcommand[[(reset)]m.[[(reset)]m'$'\n'''$'\n''Run a command after changing directory to it and then returning to the previous directory afterwards.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
