...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mjsonField [[(blue)]m[ --help ] [[(magenta)]mhandler [[(magenta)]mjsonFile [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(blue)]m--help    [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(red)]mhandler   [[(value)]mFunction. Required. Error handler.'$'\n''    [[(red)]mjsonFile  [[(value)]mFile. Required. A JSON file to parse'$'\n''    [[(blue)]m...       [[(value)]mArguments. Optional. Passed directly to jq'$'\n'''$'\n''Fetch a non-blank field from a JSON file with error handling'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Field was found and was non-blank'$'\n''- [[(code)]m1 - Field was not found or is blank'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''selected field'$'\n'''
# elapsed 2.583
