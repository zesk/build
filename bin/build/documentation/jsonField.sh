...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mjsonField [[(blue)]m[ --help ] [[(bold)]m[[(magenta)]mhandler [[(bold)]m[[(magenta)]mjsonFile [[(blue)]m[ ... ]'$'\n'''$'\n''    [[(blue)]m--help    [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n''    [[(red)]mhandler   [[(value)]mFunction. Required. Error handler.[[(reset)]m'$'\n''    [[(red)]mjsonFile  [[(value)]mFile. Required. A JSON file to parse[[(reset)]m'$'\n''    [[(blue)]m...       [[(value)]mArguments. Optional. Passed directly to jq[[(reset)]m'$'\n'''$'\n''Fetch a non-blank field from a JSON file with error handling'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Field was found and was non-blank'$'\n''- [[(code)]m1[[(reset)]m - Field was not found or is blank'$'\n'''$'\n''Writes to [[(code)]mstdout[[(reset)]m:'$'\n''selected field'$'\n'''
