...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mnetworkIPList [[(blue)]m[ --install ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]m--install  [[(value)]mFlag. Optional. Install any packages required to get [[(code)]mifconfig[[(reset)]m installed first.[[(reset)]m'$'\n''    [[(blue)]m--help     [[(value)]mFlag. Optional. This help.[[(reset)]m'$'\n'''$'\n''List IPv4 Addresses associated with this system using [[(code)]mifconfig[[(reset)]m'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
