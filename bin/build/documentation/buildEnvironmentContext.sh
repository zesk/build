...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: buildEnvironmentContext [[(bold)]m[[(magenta)]mcontextStart [[(bold)]m[[(magenta)]mcommand ...'$'\n'''$'\n''    [[(red)]mcontextStart  [[(value)]mDirectory. Required. Context in which the command should run.'$'\n''    [[(red)]mcommand ...   [[(value)]mRequired. Command to run in new context.'$'\n'''$'\n''Run a command and ensure the build tools context matches the current project'$'\n''Avoid infinite loops here, call down.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.524
