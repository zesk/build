...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mphpTest [[(blue)]m[ --env-file envFile ] [[(blue)]m[ --home homeDirectory ]'$'\n'''$'\n''    [[(blue)]m--env-file envFile    [[(value)]mFile. Optional. Environment file to load.[[(reset)]m'$'\n''    [[(blue)]m--home homeDirectory  [[(value)]mDirectory. Optional. Directory for application home.[[(reset)]m'$'\n'''$'\n''Test a docker-based PHP application during build'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
# elapsed 3.021
