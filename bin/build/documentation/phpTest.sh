...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: phpTest [[(blue)]m[ --env-file envFile ] [[(blue)]m[ --home homeDirectory ]'$'\n'''$'\n''    [[(blue)]m--env-file envFile    [[(value)]mFile. Optional. Environment file to load.'$'\n''    [[(blue)]m--home homeDirectory  [[(value)]mDirectory. Optional. Directory for application home.'$'\n'''$'\n''Test a docker-based PHP application during build'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 2.916
