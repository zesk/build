...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: fileTeeAtomic [[(blue)]m[ -a ] [[(bold)]m[[(magenta)]mtarget [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(blue)]m-a      [[(value)]mFlag. Optional. Append target (atomically as well).'$'\n''    [[(red)]mtarget  [[(value)]mFile. Required. File to target'$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Write to a file in a single operation to avoid invalid files'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Reads from [[(code)]mstdin:'$'\n''Piped to a temporary file until EOF and then moved to target'$'\n'''$'\n''Writes to [[(code)]mstdout:'$'\n''A copy of stdin'$'\n'''
