...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]murlParseItem [[(blue)]m[ component ] [[(magenta)]murl ...'$'\n'''$'\n''    [[(blue)]mcomponent  [[(value)]mthe url component to get: [[(code)]murl, [[(code)]mpath, [[(code)]mname, [[(code)]mscheme, [[(code)]muser, [[(code)]mpassword, [[(code)]mhost, [[(code)]mport, [[(code)]mportDefault, [[(code)]merror'$'\n''    [[(red)]murl ...    [[(value)]mString. URL. Required. A Uniform Resource Locator used to specify a database connection'$'\n'''$'\n''Extract a component from one or more URLs'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''$'\n''Example:'$'\n''    decorate info "Connecting as $(urlParseItem user "$url")"'$'\n'''
