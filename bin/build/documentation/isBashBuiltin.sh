...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]misBashBuiltin [[(bold)]m[[(magenta)]mbuiltin'$'\n'''$'\n''    builtin  [[(value)]mString. Required. String to check if it'\''s a bash builtin.'$'\n'''$'\n''No documentation for [[(code)]misBashBuiltin.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Yes, this string is a bash builtin command.'$'\n''- [[(code)]m1 - No, this is not a bash builtin command'$'\n'''
# elapsed 2.69
