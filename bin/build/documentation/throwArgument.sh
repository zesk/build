...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mthrowArgument [[(bold)]m[[(magenta)]mhandler [[(blue)]m[ message ... ]'$'\n'''$'\n''    [[(red)]mhandler      [[(value)]mFunction. Required. Failure command'$'\n''    [[(blue)]mmessage ...  [[(value)]mString. Optional. Error message to display.'$'\n'''$'\n''Run [[(code)]mhandler with an argument error'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 1.746
