...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mdocumentationTemplateUpdate [[(bold)]m[[(magenta)]mtemplatePath [[(blue)]m[ --help ]'$'\n'''$'\n''    templatePath  [[(value)]mDirectory. Required. Path to the templates to repair.'$'\n''    [[(blue)]m--help        [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Map template files using our identical functionality'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
