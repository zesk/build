...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: documentationTemplateUpdate [[(magenta)]mtemplatePath [ --help ]'$'\n'''$'\n''    [[(red)]mtemplatePath  [[(value)]mDirectory. Required. Path to the templates to repair.'$'\n''    --help        [[(value)]mFlag. Optional. Display this help.'$'\n'''$'\n''Map template files using our identical functionality'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.081
