...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mdirectoryPathSimplify [[(bold)]m[[(magenta)]mpath ...'$'\n'''$'\n''    [[(red)]mpath ...  [[(value)]mFile. Required. One or more paths to simplify'$'\n'''$'\n''Normalizes segments of [[(code)]m/./ and [[(code)]m/../ in a path without using [[(code)]mrealPath'$'\n''Removes dot and dot-dot paths from a path correctly'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
