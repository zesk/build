...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mbooleanChoose [[(magenta)]mtestValue [[(blue)]m[ trueChoice ] [[(blue)]m[ falseChoice ]'$'\n'''$'\n''    [[(red)]mtestValue    [[(value)]mBoolean. Required. Test value'$'\n''    [[(blue)]mtrueChoice   [[(value)]mEmptyString. Optional. Value to output when testValue is true'$'\n''    [[(blue)]mfalseChoice  [[(value)]mEmptyString. Optional. Value to output when testValue is false'$'\n'''$'\n''Boolean selector'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
