...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mtimingElapsed [[(bold)]m[[(magenta)]mtimingOffset [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mtimingOffset  [[(value)]mUnsignedInteger. Required. Offset in milliseconds from January 1, 1970.[[(reset)]m'$'\n''    [[(blue)]m--help        [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Show elapsed time from a start time'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''$'\n''Example:'$'\n''    init=$(timingStart)'$'\n''    ...'$'\n''    timingElapsed "$init"'$'\n'''
# elapsed 3.94
