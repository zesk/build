...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mconsoleLink [[(bold)]m[[(magenta)]mlink [[(blue)]m[ text ] [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mlink    [[(value)]mEmptyString. Required. Link to output.[[(reset)]m'$'\n''    [[(blue)]mtext    [[(value)]mString. Optional. Text to display, if none then uses [[(code)]mlink[[(reset)]m.[[(reset)]m'$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Output a hyperlink to the console'$'\n''OSC 8 standard for terminals'$'\n''No way to test ability, I think. Maybe [[(code)]mtput[[(reset)]m.'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
