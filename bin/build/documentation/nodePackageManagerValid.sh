...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mnodePackageManagerValid [[(blue)]m[ --help ] [[(bold)]m[[(magenta)]mmanagerName'$'\n'''$'\n''    [[(blue)]m--help       [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(red)]mmanagerName  [[(value)]mString. Required. The node package manager name to check.'$'\n'''$'\n''Is the passed node package manager name valid?'$'\n''Without arguments, shows the valid package manager names.'$'\n'''$'\n''Return codes:'$'\n''- 0 - Yes, it'\''s a valid package manager name.'$'\n''- 1 - No, it'\''s not a valid package manager name.'$'\n'''
