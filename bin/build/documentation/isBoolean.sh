...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]misBoolean [[(blue)]m[ --help ] [[(blue)]m[ value ]'$'\n'''$'\n''    [[(blue)]m--help  [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(blue)]mvalue   [[(value)]mString. Optional. Value to check if it is a boolean.'$'\n'''$'\n''Boolean test'$'\n''If you want "true-ish" use [[(code)]misTrue.'$'\n''Returns 0 if [[(code)]mvalue is boolean [[(code)]mfalse or [[(code)]mtrue.'$'\n''Is this a boolean? ([[(code)]mtrue or [[(code)]mfalse)'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - if value is a boolean'$'\n''- [[(code)]m1 - if value is not a boolean'$'\n'''
# elapsed 3.022
