...
# shellcheck disable=SC2016
helpPlain='Usage: consoleHeadingLine [[(magenta)]mbarText [[(blue)]m[ displayText ]'$'\n'''$'\n''    [[(red)]mbarText      String. Required. Text to fill line with, repeated. If not specified uses -'$'\n''    [[(blue)]mdisplayText  String. Optional.  Text to display on the line before the fill bar.'$'\n'''$'\n''Output a line and fill columns with a character'$'\n'''$'\n''Return codes:'$'\n''- 0 - Success'$'\n''- 1 - Environment error'$'\n''- 2 - Argument error'$'\n'''
# elapsed 3.147
