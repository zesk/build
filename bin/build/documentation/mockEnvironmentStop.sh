...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mmockEnvironmentStop [[(bold)]m[[(magenta)]mglobalName ... [[(blue)]m[ --help ]'$'\n'''$'\n''    [[(red)]mglobalName ...  [[(value)]mEnvironmentVariable. Required. Global to restore from the mocked saved value.[[(reset)]m'$'\n''    [[(blue)]m--help          [[(value)]mFlag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Restore a mocked value. Works solely with the default [[(code)]msaveGlobalName[[(reset)]m (e.g. [[(code)]m__MOCK_${globalName}[[(reset)]m).'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
