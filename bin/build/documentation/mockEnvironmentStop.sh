...
# shellcheck disable=SC2016
helpPlain='[[(label)]mUsage: [[(info)]mmockEnvironmentStop [[(blue)]m[ --help ] [[(bold)]m[[(magenta)]mglobalName ...'$'\n'''$'\n''    [[(blue)]m--help          [[(value)]mFlag. Optional. Display this help.'$'\n''    [[(red)]mglobalName ...  [[(value)]mEnvironmentVariable. Required. Global to restore from the mocked saved value.'$'\n'''$'\n''Restore a mocked value. Works solely with the default [[(code)]msaveGlobalName (e.g. [[(code)]m__MOCK_${globalName}).'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0 - Success'$'\n''- [[(code)]m1 - Environment error'$'\n''- [[(code)]m2 - Argument error'$'\n'''
# elapsed 3.488
