...
# shellcheck disable=SC2016
helpPlain='Usage: [[(info)]mcharacterFromInteger [ --help ]'$'\n'''$'\n''    --help  Flag. Optional. Display this help.[[(reset)]m'$'\n'''$'\n''Given a list of integers, output the character codes associated with them (e.g. [[(code)]mchr[[(reset)]m in other languages)'$'\n'''$'\n''Return codes:'$'\n''- [[(code)]m0[[(reset)]m - Success'$'\n''- [[(code)]m1[[(reset)]m - Environment error'$'\n''- [[(code)]m2[[(reset)]m - Argument error'$'\n'''
# elapsed 3.584
