...
- - `2` - Argument error
- 
- [documentationIndexGenerate]({rel}#documentationindexgenerate) - Generate a function index for bash files. ([source](https://github.com/zesk/build/blob/main/bin/build/tools/documentation.sh#L352))## `documentationIndexLookup`
- 
...
- - `2` - Argument error
- 
- [documentationMake]({rel}#documentationmake) - Make documentation for Bash functions ([source](https://github.com/zesk/build/blob/main/bin/build/tools/documentation.sh#L92))[documentationMaker]({rel}#documentationmaker) - Generate documentation using source markdown and a mapping function. ([source](https://github.com/zesk/build/blob/main/bin/build/tools/documentation.sh#L443))## `documentationMkdocs`
- 
...
- - ## `buildCacheDirectory`
- 
- [installInstallBinary]({rel}#installinstallbinary) - Installs an installer the first time in a new project, ([source](https://github.com/zesk/build/blob/main/bin/build/tools/build.sh#L32))## `installInstallBuild`
- 
