# Known {applicationName} Artifacts

These are files which are generated by {applicationName} for various purposes.
...
- {applicationName} generates for own build (by `bin/build.sh`)
